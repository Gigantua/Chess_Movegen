...
namespace Chess_Lookup {
	...
	template<int Slidersquare> static constexpr uint64_t GetSliderHCond(uint64_t occupy){
		uint64_t result{};
		if constexpr (Slidersquare == 0){
			result = 2ull;
			if ((occupy & 2ull) == 0) result |= 4ull;
			if ((occupy & 6ull) == 0) result |= 8ull;
			if ((occupy & 14ull) == 0) result |= 16ull;
	...
	template<int Slidersquare> static constexpr uint64_t GetSliderVCond(uint64_t occupy){
		uint64_t result{};
		if constexpr (Slidersquare == 0){
			result = 256ull;
			if ((occupy & 256ull) == 0) result |= 65536ull;
	...
	template<int Slidersquare> static constexpr uint64_t GetSliderD2Cond(uint64_t occupy){
		uint64_t result{};
		if constexpr (Slidersquare == 0){
			result = 0ull;
			return result;}
	...
	template<int Slidersquare> static constexpr uint64_t GetSliderD1Cond(uint64_t occupy){
		uint64_t result{};
		if constexpr (Slidersquare == 0){
			result = 512ull;
			if ((occupy & 512ull) == 0) result |= 262144ull;
