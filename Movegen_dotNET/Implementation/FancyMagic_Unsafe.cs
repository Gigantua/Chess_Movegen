...
{
    public static unsafe class FancyMagic_Unsafe
    {
        static ulong* lookup_Table = (ulong*)Marshal.AllocHGlobal(88507 * sizeof(ulong));
            ...
            for (int x = 0; x < 8; x++)
            {
                for (int y = 0; y < 8; y++)
                {
                    ...
                    for (ulong i = 0; i < (ulong)(1 << cnt); i++)
                    {
                        ...
                        *rIndex(sq, occ) = Switch.Rook(sq, occ);
                    }
                    ...
                    for (ulong i = 0; i < (ulong)(1 << cnt); i++)
                    {
                        ...
                        *bIndex(sq, occ) = Switch.Bishop(sq, occ);
                    }
                }
            }
        }
