...
{
    public static class Switch_JumpTable
    {
        ...
        (occupy) => {
        ulong result = 175921860444160ul;
        ...
        (occupy) => {
        ulong result = 562949953421312ul;
        ...
        (occupy) => {
        ulong result = 1407374883553280ul;
        ...
        (occupy) => {
        ulong result = 2814749767106560ul;
        ...
        (occupy) => {
        ulong result = 5629499534213120ul;
        ...
        (occupy) => {
        ulong result = 11258999068426240ul;
        ...
        (occupy) => {
        ulong result = 22517998136852480ul;
        ...
        (occupy) => {
        ulong result = 45035996273704960ul;
        ...
        (occupy) => {
        ulong result = 18014398509481984ul;
        ...
        (occupy) => {
        ulong result = 144115188075855872ul;
        ...
        (occupy) => {
        ulong result = 360287970189639680ul;
        ...
        (occupy) => {
        ulong result = 720575940379279360ul;
        ...
        (occupy) => {
        ulong result = 1441151880758558720ul;
        ...
        (occupy) => {
        ulong result = 2882303761517117440ul;
        ...
        (occupy) => {
        ulong result = 5764607523034234880ul;
        ...
        (occupy) => {
        ulong result = 11529215046068469760ul;
        ...
        (occupy) => {
        ulong result = 4611686018427387904ul;
        ...
        public static Func<ulong, ulong>[] GetSliderVCond = new Func<ulong, ulong>[]
                {
        (occupy) => {
        ulong result = 256ul;
        ...
        (occupy) => {
        ulong result = 140739635838976ul;
        ...
        (occupy) => {
        ulong result = 281479271677952ul;
        ...
        (occupy) => {
        ulong result = 562958543355904ul;
        ...
        (occupy) => {
        ulong result = 1125917086711808ul;
        ...
        (occupy) => {
        ulong result = 2251834173423616ul;
        ...
        (occupy) => {
        ulong result = 4503668346847232ul;
        ...
        (occupy) => {
        ulong result = 9007336693694464ul;
        ...
        (occupy) => {
        ulong result = 18014673387388928ul;
        ...
        (occupy) => {
        ulong result = 36029346774777856ul;
        ...
        (occupy) => {
        ulong result = 72058693549555712ul;
        ...
        (occupy) => {
        ulong result = 144117387099111424ul;
        ...
        (occupy) => {
        ulong result = 288234774198222848ul;
        ...
        (occupy) => {
        ulong result = 576469548396445696ul;
        ...
        (occupy) => {
        ulong result = 1152939096792891392ul;
        ...
        (occupy) => {
        ulong result = 2305878193585782784ul;
        ...
        (occupy) => {
        ulong result = 4611756387171565568ul;
        ...
        (occupy) => {
        ulong result = 9223512774343131136ul;
        ...
        (occupy) => {
        ulong result = 281474976710656ul;
        ...
        (occupy) => {
        ulong result = 1125899906842624ul;
        ...
        (occupy) => {
        ulong result = 2251799813685248ul;
        ...
        (occupy) => {
        ulong result = 4503599627370496ul;
        ...
        (occupy) => {
        ulong result = 9007199254740992ul;
        ...
        (occupy) => {
        ulong result = 36028797018963968ul;
        ...
        public static Func<ulong, ulong>[] GetSliderD2Con = new Func<ulong, ulong>[]
                {
        (occupy) => {
        ulong result = 0ul;
        return result;
        ...
        (occupy) => {
        ulong result = 281492156579840ul;
        ...
        (occupy) => {
        ulong result = 562984313159680ul;
        ...
        (occupy) => {
        ulong result = 1125968626319360ul;
        ...
        (occupy) => {
        ulong result = 2251937252638720ul;
        ...
        (occupy) => {
        ulong result = 72061992084439040ul;
        ...
        (occupy) => {
        ulong result = 144123984168878080ul;
        ...
        (occupy) => {
        ulong result = 288247968337756160ul;
        ...
        public static Func<ulong, ulong>[] GetSliderD1Con = new Func<ulong, ulong>[]
        {
        (occupy) => {
        ulong result = 512ul;
        ...
        (occupy) => {
        ulong result = 140738025226240ul;
        ...
        (occupy) => {
        ulong result = 9007233614479360ul;
        ...
        (occupy) => {
        ulong result = 18014467228958720ul;
        ...
        (occupy) => {
        ulong result = 36028934457917440ul;
        ...
        (occupy) => {
        ulong result = 4611703610613432320ul;
        ...
        (occupy) => {
        ulong result = 9223407221226864640ul;
        ...
        {
            return GetSliderD1Con[square](occupy) | GetSliderD2Con[square](occupy);
        }
