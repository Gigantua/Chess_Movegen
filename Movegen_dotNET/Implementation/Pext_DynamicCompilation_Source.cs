...
{
    public static class Pext_DynamicCompilation_Source
    {
		//This could be used to add runtime information to the graph of chess - optimally compiled IL at runtime!
...
public static class Switch
    ...
    public static class Pext
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong Queen_Compiled(int sq, ulong occupy)
        {
